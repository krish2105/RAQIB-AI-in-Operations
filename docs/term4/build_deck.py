...
def main() -> None:
    ...
    s = slide(prs, "Live demo", "raqib.vercel.app", "Grader path in under ten minutes: dashboard → tape tick → event clip and decision → approve a proposal → executed and audited → forecast → report. QR on this slide when deployed.", 5)
